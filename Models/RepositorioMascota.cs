...
namespace VeterinariaSystem.Models
{
    ...
    {
        public RepositorioMascota(IConfiguration configuration) : base(configuration)
        {}
        ...
        public Mascota ObtenerPorId(int id)
        {
            ...
            using (var connection = new MySqlConnection(connectionString))
            {
                string sql = @"SELECT m.Id, m.Nombre, m.Especie, m.Raza, m.Edad, m.Peso, m.Sexo, m.Id_Dueno, m.Estado,
        ...
        public IList<Mascota> ObtenerPorDueno(int idDueno)
        {
            IList<Mascota> lista = new List<Mascota>();
            using (var connection = new MySqlConnection(connectionString))
            {
